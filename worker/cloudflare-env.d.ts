/* eslint-disable */
// Generated by Wrangler by running `wrangler types --cwd worker --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 55fc13f4e27d3b1490b7bc0c6ce4e26a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_BASE_URL" | "OPENAI_API_KEY" | "GOOGLE_BASE_URL" | "GOOGLE_API_KEY" | "ANTHROPIC_BASE_URL" | "ANTHROPIC_API_KEY" | "OPENCODE_MODEL" | "OPENCODE_SMALL_MODEL" | "EDITOR_MODEL" | "REVIEW_MODEL" | "WRITER_MODEL" | "SERVER_USERNAME" | "SERVER_PASSWORD" | "FIRECRAWL_API_KEY">> {}
}
